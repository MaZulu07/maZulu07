...
|------------|----------------|---------------|---------------|---------|
| **Attendance Register System** | Java console application to sign and display worker attendance records with timestamps. | Java (OOP, Collections, LocalDateTime, Scanner) | Local run / Executable JAR | [Repository](https://github.com/MaZulu07/attendance) |
